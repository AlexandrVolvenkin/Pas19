...
//    }
    ...
    m_pxStorageDevice -> WritePrepare(TEMPORARY_SERVICE_SECTION_DATA_BEGIN,
...
//    }
    ...
    m_pxStorageDevice -> WritePrepare(SERVICE_SECTION_DATA_BEGIN,
                                      m_puiIntermediateBuff,
                                      uiEncodedByteCounter);
