...
//-----------------------------------------------------------------------------------------------------
void CSerialPort::SetPortName(const char* cPortName)
{
...
//-----------------------------------------------------------------------------------------------------
void CSerialPort::SetParity(uint8_t uiParity)
{
...
{
//    return read(reinterpret_cast<char*>(puiDestination), uiLength);
}

//-----------------------------------------------------------------------------------------------------
int16_t CSerialPort::Write(uint8_t *puiSource, uint16_t uiLength)
{
//    return write(reinterpret_cast<char*>(puiSource), uiLength);
}
...
{
//    return static_cast<uint16_t>(QDateTime::currentMSecsSinceEpoch());
}
